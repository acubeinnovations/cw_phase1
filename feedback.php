...
$page = new Page;
	...
	$page->page_name = 'feedback';		// page name for menu and other purpose
	...
	$page->class_list = array("class_email.php");
    ...
    $content_list[$index]['file_name']='inc_feedback.php';
	...
	$page->module_path 	= '/modules/feedback/';
	$page->module		= 'feedback_mail';
