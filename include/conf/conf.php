...
//Email
define("EMAIL_FEEDBACK", "feedback@cworld.local");
define("EMAIL_NO_REPLY", "noreply@cworld.local");
define("EMAIL_INFO", "noreply@cworld.local");
define("EMAIL_SUPPORT", "noreply@cworld.local");


define("WEB_URL", "http://cworld.local");
define("ADMIN_URL", "http://cworld.local/admin");
define("WEB_NAME", "cworld.local");
define("ORG_NAME", "cworld");
